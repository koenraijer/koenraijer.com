<div class="flex flex-row flex-wrap gap-2">
    ...
    <a class="social" target="_blank" aria-label="Github" rel="noopener" href="https://www.linkedin.com/in/koen-raijer-3495a7127/">
    ...
    <a class="social " target="_blank" aria-label="LinkedIn" rel="noopener" href="mailto:koenrayer@gmail.com">
