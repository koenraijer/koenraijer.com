...
<a class={classes + " inline-flex my-0 break-all group"} href={href} {target} {rel}>
    ...
    {#if isExternal && !isWikipedia}
				<ArrowUpRight class="w-3 h-3 inline-flex self-start text-inherit stroke-2 mt-1 -ml-0.5 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform"/>
