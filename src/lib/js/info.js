...
// Git commit info (injected at build time)
export const git_commit_hash =
	typeof __GIT_COMMIT_HASH__ !== 'undefined' ? __GIT_COMMIT_HASH__ : '';
export const git_commit_date =
	typeof __GIT_COMMIT_DATE__ !== 'undefined' ? __GIT_COMMIT_DATE__ : '';
export const git_commit_url = git_commit_hash
	? `${github_repo}/commit/${git_commit_hash}`
	: github_repo;
